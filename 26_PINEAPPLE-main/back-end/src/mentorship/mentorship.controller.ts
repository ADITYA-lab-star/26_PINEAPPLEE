...
@ApiTags('Mentorship')
@ApiHeader({ name: 'x-user-role', description: 'User role for RBAC', required: false })
...
export class MentorshipController {
  ...
  @Get('applications')
  @Roles('Administrator')
  @ApiOperation({ summary: 'Get all mentorship applications (Admin only)' })
  getAllApplications() {
    return this.mentorshipService.getAllApplications();
  }
